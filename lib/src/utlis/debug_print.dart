...
/// Signature for [debugPrintSnug] implementations.
///
...
/// [debugPrintSnug] variable to a new implementation that matches the
...
/// Implementation of [debugPrintSnug] that throttles messages. This avoids dropping
...
/// [debugPrintSnug], which is used to report errors to the console).
...
///
/// The default [debugPrintSnug] implementation uses this for its line wrapping.
